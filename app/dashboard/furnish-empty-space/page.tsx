...
// Style categories specific to furnishing
const furnishingStyles = [
  ...
  { id: "coastal", label: "COASTAL", image: "/images/styles/coastal.jpg" },
  { id: "vintage", label: "VINTAGE", image: "/images/styles/vintage.jpg" },
  { id: "tropical", label: "TROPICAL", image: "/images/styles/tropical.jpg" },
];

function FurnishEmptySpace() {
  // Component state
  ...
  if (!isComponentsLoaded) {
    return <LoadingSpinner message="Loading furnishing studio..." />;
  }
        ...
        <div className="flex-1 flex flex-col">
          ...
          <div className="bg-white border-b px-6 py-4">
            ...
            <p className="text-gray-600">
              Transform your empty room with AI-powered furniture arrangement
            </p>
          </div>
          ...
          <div className="bg-white border-t px-6 py-3">
            <div className="flex items-center justify-center">
              <p className="text-sm text-gray-600">
                Upload an empty room and select furnishing styles to get started
              </p>
            </div>
          </div>
        </div>
