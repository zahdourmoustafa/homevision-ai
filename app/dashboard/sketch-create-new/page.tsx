...
function SketchCreateNew() {
  ...
  const onHandleInputChanged = useCallback((value: string, fieldName: string) => {
    setFormData(prev => ({
      ...prev,
      [fieldName]: value
    }));
      ...
      <div className="w-full md:w-[600px] border-b md:border-b-0 md:border-r bg-white p-3">
        <div className="space-y-4 pt-4">
          ...
          <div className="px-8">
            ...
            <p className='text-xs text-gray-400 mt-2'>NOTE: 1 credit will be used to convert your sketch</p>
          </div>
        </div>
      </div>
          ...
          {generatedResults.length > 0 ? (
            ...
            <div className="w-full max-w-4xl flex flex-col items-center justify-center p-6">
              ...
              <div className="text-center">
                <h1 className="text-xl font-bold">Upload your sketch to get started</h1>
                <p className="text-gray-500 text-sm mt-2">
                  Transform your hand-drawn room sketches into photorealistic interior designs.
                </p>
              </div>
            </div>
          )}
